...
/**
 * Test for /api/prescriptions/{prescriptionId}
 */
Test('/api/prescriptions/{prescriptionId}', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/prescriptions/{prescriptionId}']['get']['responses']['200']['schema']);
